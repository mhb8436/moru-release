...
<p align="center">
  전자정부 표준프레임워크 5.0 위에서 돌아가는 누리집 CMS와 통합검색, 문서 AI, 위원회 업무 팩입니다.<br>
...
▶ **시연 영상(1분 59초, mp4)** — 아래 일곱 장면에 제목과 자막을 붙여 한 편으로 이었습니다. [내려받기](https://github.com/mhb8436/moru-release/releases/download/v1.1/MORU-demo-v1.1.mp4) · [제품 페이지에서 바로 보기](https://mhb8436.github.io/moru-release/#demo)
...
표준프레임워크는 프레임워크일 뿐, 그대로 쓸 수 있는 제품은 아닙니다. 그래서 사업마다 계정과 권한, 게시판, 첨부, 표준사전, 배치를 처음부터 다시 만들어 왔습니다. MORU는 그 자리를 미리 채워 둔 제품입니다. 이름은 대장간에서 달군 쇠를 올려놓고 두드리는 받침쇠 ‘모루’에서 따왔습니다.
...
- **Tailwind를 쓰신다면** `styles/krds-tailwind.css`를 같이 불러오십시오. `text-fg-subtle` 같은 이름을 KRDS 변수에 이어 줍니다. 불러오지 않아도 부품은 그대로 돌아갑니다.
- **규칙은 소스에 적어 두었습니다.** 부품마다 파일 머리에 무엇을 지켜야 하는지, 무엇을 하면 안 되는지 써 두었습니다.
...
- **도입 형태** — 기관 서버에 설치해 씁니다. 프로세스 세 개를 한 대에 몰아 두어도 되고, 세 대로 나누어도 됩니다. 클라우드 계정이나 바깥 SaaS에는 붙지 않습니다.
